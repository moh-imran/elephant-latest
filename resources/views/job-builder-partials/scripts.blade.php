...
<script src="{{ URL::asset('public/js/job-builder-js/jquery-2.2.4.min.js') }}"> </script>
<script src="{{ URL::asset('public/js/job-builder-js/jquery.magicsearch.min.js') }}"> </script>
<script src="{{ URL::asset('public/js/job-builder-js/common_scripts.min.js') }}"> </script>
