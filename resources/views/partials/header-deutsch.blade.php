            ...
            <div class="container">
                <div class="row">
                    <div class="col-3 col-md-2">
                        <a href="{{ url('/de') }}"> <img class="logo logo-dark" alt="logo" src="{{ asset('public/img/logo-icon.png') }}"> <img class="logo logo-light" alt="logo" src="{{ asset('public/img/logo-icon.png') }}"> </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-2 text-center text-left-sm hidden-xs order-lg-2">
                        <div class="bar__module">
                            <a href="{{ url('/de') }}"> <img class="logo logo-dark" alt="logo" src="{{ asset('public/img/logo.png') }}"> <img class="logo logo-light" alt="logo" src="{{ asset('public/img/logo.png') }}"> </a>
                        </div>
                    </div>
