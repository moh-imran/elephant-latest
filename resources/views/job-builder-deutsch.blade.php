...
<div class="main-container">
    ...
    <section class="cover imagebg text-center parallax height-50" data-overlay="6">
        <div class="background-image-holder"> <img alt="background" src="{{ asset('public/img/hero-slider/hero-image-3.jpg')  }}"> </div>
...
<script src="{{ URL::asset('public/js/vue/jobForm.js') }}"> </script>
</body>
</html>