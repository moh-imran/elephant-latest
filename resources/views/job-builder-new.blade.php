...
<header>
    <div class="container-fluid">
        <div class="row">
            <div class="col-3">
                <div id="logo_home">
                    <h1><a href="index3.html">STEPS | Multipurpose Working Wizard with Branches</a></h1>
                </div>
            </div>
            <div class="col-9">
                <div id="social">
...
<footer>
    <div class="container clearfix">
        <ul>
            <li><a href="http://stage.elephant-hr.de" class="animated_link"> << Back to Website</a></li>
